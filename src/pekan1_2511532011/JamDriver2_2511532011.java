...
public class JamDriver2_2511532011 {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n --- Input Jam 1 ---");
		Jam_2511532011 j1 = buatJamDariInput(input);
		
		System.out.println("\n --- Input Jam 2 ---");
		Jam_2511532011 j2 = buatJamDariInput(input);
		...
		System.out.println("Durasi (J1 ke J2)         :" + Jam_2511532011.durasiDetik(j1, j2) + "detik");
		
		Jam_2511532011 jNext = j1.nextSeconds();
		System.out.println("Jam 1 Detik Berikutnya:" + jNext);
		
		Jam_2511532011 jPrev = j1.prevSeconds();
		System.out.println("Jam 1 Detik Berikutnya:" + jPrev);
		
		Jam_2511532011 jHasilPlus = j1.plus(j2);
	...
	private static Jam_2511532011 buatJamDariInput(Scanner sc) {
		int h, m, s;
		while(true) {
			...
			if (Jam_2511532011.isValid(h, m, s))
